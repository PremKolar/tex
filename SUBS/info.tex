...
%[Mesoscale Eddy Dynamics via a SSH-based Tracking Algorithm]
\thesistitle{A Global Analysis of Mesoscale Eddy Dynamics via a Surface-Signature-Based Tracking Algorithm} 
\title{\protect\footnotesize{A Global Analysis of Mesoscale Eddy Dynamics via a Surface-Signature-Based Tracking Algorithm}} % Title of the book
%-------------------------------------------------
\supervisor{Prof. Dr. Carsten Eden} % You supervisor's name - this is used in the title page
%-------------------------------------------------
\cosupervisor{Prof. Dr. Johanna Baehr} % You cosupervisor's name - this is used in the title page
%-------------------------------------------------
\authors{Nikolaus Koopmann} % Your name - this is used in the title page and abstract
%-------------------------------------------------
