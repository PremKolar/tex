\thesistitle{A Global Analysis of Mesoscale Eddy Dynamics via a Surface-Signature-Based Tracking Algorithm} % Your thesis title - this is used in the titleand abstract
\title{A Global Analysis of Mesoscale Eddy Dynamics via a Surface-Signature-Based Tracking Algorithm} % Title of the book
%-------------------------------------------------
