...
\thesistitle{\uppercase{E}ddy \uppercase{D}etection \uppercase{A}nd \uppercase{T}racking} 
\title{\protect\footnotesize{\uppercase{E}ddy \uppercase{D}etection \uppercase{A}nd \uppercase{T}racking}} % Title of the book
%-------------------------------------------------
