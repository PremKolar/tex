...
A well-documented \textit{core}-version (stripped of all experimental and redundant add-ons) will be made public on github presumably as early as end of June 2015 and no later than August 2015. 
...
\end{figure*}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \section[Finding the Contours]{Step S03: Find Contours} \label{S:03}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section[Filtering the Contours]{Step S04: Filter Contours} \label{S:04}
