...
\newcommand{\ie}{\textit{i.\hairsp{}e.}~} % Command to print i.e.
\newcommand{\eg}{\textit{e.\hairsp{}g.}~} % Command to print e.g.
\newcommand{\Eg}{E.g.~}
\newcommand{\Ie}{I.e.~}
...
{
\refstepcounter{speedbox}\par\medskip\noindent
\def\FrameCommand{\colorbox{speedboxcolor}}%
\MakeFramed{\advance\hsize-\width \FrameRestore\cornersize{0.9}}
\begin{scriptsize}
\begin{center}
\textbf{Drift~Speed~\thespeedbox~- #1}
\end{center}
}
{
\end{scriptsize}
...
\newcommand{\C}[0]{\hyperref[def:C]{C~}}
...
\newcommand{\popOneIISO}[0]{\hyperref[def:pop1IISO]{POP-1day-MII-Southern-Ocean}~}
\newcommand{\MI}[0]{\hyperref[box:MI]{MI}~}
\newcommand{\MII}[0]{\hyperref[box:MII]{MII}~}
\newcommand{\POP}[0]{\hyperref[def:POP]{POP}~}
\newcommand{\AVI}[0]{\hyperref[def:AVISO]{AVISO}~}
...
\newcommand{\vdqi}{\textit{VDQI}~}
\newcommand{\ei}{\textit{EI}~}
\newcommand{\ve}{\textit{VE}~}
\newcommand{\be}{\textit{BE}~}
\newcommand{\VDQI}{\textit{The Visual Display of Quantitative Information}~}
\newcommand{\EI}{\textit{Envisioning Information}~}
\newcommand{\VE}{\textit{Visual Explanations}~}
\newcommand{\BE}{\textit{Beautiful Evidence}~}
\newcommand{\TL}{Tufte-\LaTeX~}
