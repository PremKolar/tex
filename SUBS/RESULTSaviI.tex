...
\newthought{The}~eastward zonal drift speeds are slightly slower than the first-mode long Rossby wave phase speed and agree well with the results from \citet{Chelton2011}. Propagation is generally westwards except for regions of sufficiently strong eastward advection as in the ACC and North Atlantic Current (see \cref{fig:velZon-aviI,fig:ScheltsAll}).
