...
\end{definition}
%###################################%
\begin{definition}[Kinetic Energy per mass $\Ek \Unit{\si{m^{2}/s^{2}}}$] \label{def:E_k}
\end{definition}
%###################################%
...
\end{definition}
%###################################%
\begin{definition}[Surface/interface Displacement $\eta(x,y) \Unit{\si{m}}$]\label{def:eta}
\end{definition}
%###################################%
\begin{definition}[Mean Layer thickness $H \Unit{\si{m}}$]\label{def:H}
\end{definition}
%###################################%
