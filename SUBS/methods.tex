...
\newthought{The }  translational speeds ($\order{1}\si{km/\day}$) of eddies are not really the problem here, as they usually drift slow enough to not cover more
...
\begin{align}
 ...
 \frac{2NH }{f} \notag \\ 
	n 
 	%&=
 %\frac{NH \mu}{f \cos{\phi}} \frac{360}{\pi a} \\
  &=
