...
\newthought{The}~\popSevenII results yield generally smaller magnitudes of drift speed.
...
\begin{figure}
	\includegraphics[]{MapVisitsBoth-pop2II}
...
\end{figure}
\newthought{So}~far, all analyses used a $\SI{7}{day}$-time-step.
...
\begin{marginfigure}
	\includegraphics[]{pop2Andpop7velZonMeanAndPop2DP}
