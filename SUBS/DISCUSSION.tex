...
\NOTE{plots only showing results from 6 years thus far. Will be updated}
...
\TODO{figure: net U zon mean. Tomorrow!}
...
\begin{figure}
	...
	\caption{Zonal drift speed of \popTwoII minus vertical mean from $1\si{\m}$ to $1000\si{\m}$  of mean background current   $\Unit{\si{\cm\per\s}}$. \TODO{take out. Almost same as 2000m}}
